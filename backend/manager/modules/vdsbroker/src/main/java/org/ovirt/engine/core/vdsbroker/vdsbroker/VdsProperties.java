...
public final class VdsProperties {
    ...
    // Quantum specific - for the POC the port will be up by default
    public static final String q_network_id    = "q_network_id";
    public static final String q_port_id       = "q_port_id";
    public static final String q_attachment_id = "q_attachment_id";
    public static final String q_plugin        = "q_plugin";
}
